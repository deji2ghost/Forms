...
export const Body = () => {
  return (
    <div className='bg-[#FFFFFF] w-full md:w-[95%] mx-auto mt-20 md:mx-0 md:flex md:justify-between text-[#2F2F2F]'>
      ...
      <div className='relative mt-[150px] h-[380px]'>
        <img 
          src={imagePortfolio} 
          alt=""
          className='md:hidden'  
        ...
        <div className='bg-[#2F2F2F] flex flex-col gap-3 md:gap-2 items-center py-[64px] px-[16px] absolute bottom-0 w-full md:p-0 md:w-0 md:bg-inherit md:static'>
          <p className='text-[#FFFFFF] font-normal text-[16px] md:hidden'>Let's Work Together</p>
          <p className='h-[7px] w-[50%] mx-auto md:mx-0 md:h-[150px] bg-[#FFB80E] md:w-1'></p>
