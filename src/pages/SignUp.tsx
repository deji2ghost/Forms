...
export const SignUp = () => {
  ...
  return (
    <FormPage>
        <div className='mx-auto text-center flex flex-col mt-5 md:mt-0 gap-6 md:w-[37%]'>
            ...
            <h1 className='text-[#2F2F2F] font-semibold text-[20px] md:text-[24px]'>
                Create Account
            </h1>
            <div className='flex flex-col md:shadow-lg md:bg-[#FDFDFD] p-4 rounded-lg gap-5'>
                <GoogleButton google>
