...
export const Login = () => {
  ...
  return (
    <div>
    <FormPage>
        <div className='mx-auto text-center flex flex-col gap-6 mt-3 md:mt-0 md:w-[37%]'>
            ...
            <h1 className='text-[#2F2F2F] text-[20px] font-semibold md:text-[24px]'>
                Login
            </h1>
            <div className='flex flex-col md:shadow-lg md:bg-[#FDFDFD] p-4 md:rounded-lg gap-5'>
                <GoogleButton google>
                ...
                <form className='flex flex-col gap-[22px]'>
                    ...
                    <div className='flex flex-col text-left relative gap-[4px]'>
                    ...
                    <p
                        className='text-[#FFB80E] -mt-3 text-left cursor-pointer text-[15px]'
